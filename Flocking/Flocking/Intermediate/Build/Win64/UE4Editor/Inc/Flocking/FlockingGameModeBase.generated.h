...
private: \
	...
	friend FLOCKING_API class UClass* Z_Construct_UClass_AFlockingGameModeBase(); \
public: \
	DECLARE_CLASS(AFlockingGameModeBase, AGameModeBase, COMPILED_IN_FLAGS(0 | CLASS_Transient), 0, TEXT("/Script/Flocking"), NO_API) \
...
#define Flocking_Source_Flocking_FlockingGameModeBase_h_15_STANDARD_CONSTRUCTORS \
	...
	NO_API AFlockingGameModeBase(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()); \
...
#define Flocking_Source_Flocking_FlockingGameModeBase_h_15_ENHANCED_CONSTRUCTORS \
	/** Standard constructor, called after all reflected properties have been initialized */ \
	NO_API AFlockingGameModeBase(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()) : Super(ObjectInitializer) { }; \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API AFlockingGameModeBase(AFlockingGameModeBase&&); \
	NO_API AFlockingGameModeBase(const AFlockingGameModeBase&); \
